...
| `ec2-instance-ids`                                                                                                                                                            | Required if you use the `stop` mode.       | EC2 Instance Id(s) of the created runner(s). <br><br> The id(s) are provided by the output of the action in the `start` mode. <br><br> The id is used to terminate the EC2 instance when the runner is not needed anymore.                                                                                                                      |
...
| `ec2-instance-ids`                                                                                                                                                            | EC2 Instance Id(s) of the created runner(s). <br><br> The id is used to terminate the EC2 instance when the runner is not needed anymore.                                                                                                       |
